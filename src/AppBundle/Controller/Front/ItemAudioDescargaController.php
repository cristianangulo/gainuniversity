...
class ItemAudioDescargaController extends Controller
{

    public function itemAudioDescargaAction($curso, $modulo, $item)
    {
        ...
        return $this->render('Front/items/item-audio-descarga.html.twig', array(
          'curso'   => $curso,
          'modulo'  => $modulo,
          'item'    => $item,
          'item_id' => $item->getId()
